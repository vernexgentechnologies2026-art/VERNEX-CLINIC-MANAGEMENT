...
import type { Appointment, AppointmentSource, QueueItem, ReceptionStats } from "../types";
...
export default function ReceptionDashboard() {
  ...
  const loadDashboard = async () => {
    try {
      const [context, appointmentRows, queueRows, doctorRows] = await Promise.all([services.auth.getCurrentAuthContext(), services.appointments.getTodayAppointments(), services.appointments.getQueue(), services.doctor.getDoctorProfiles()]);
  ...
  }), [appointments, bills.length, queue]);
